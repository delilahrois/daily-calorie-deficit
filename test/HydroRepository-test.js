...
describe('HydroRepository', function() {
  ...
  it('should be able to return the amount of water consumed each day over the last week', function() {
    expect(hydro.returnUserWaterThisWeek(2, "2019/06/21")).to.deep.equal([75, 91, 96, 70, 76, 71, 27]);
  })
})
